...
<head>
    ...
    function validate() {
        ...
        var b = document.getElementById('re_pwd');

        if (pwd.value != b.value) {
...
<body class="align">
    ...
    <div class="grid">
        <h1>Sign Up</h1>
        <form name="registration-form" action="" class="box form login" method="POST" onsubmit="return validate();">
            ...
            <div class="form__field">
                ...
                <input id="login__password2" type="password" class="form__input" id="password" name="re_pwd" id="re_pwd"
