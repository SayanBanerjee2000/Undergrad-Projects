...
<?php
					...
					?>
<script language='javascript'>
alert("Either 'Login ID' or 'Password' is incorrect. Please Verify ... Or register if you are new");
</script>
<?php
					}
	}
...
<head>
    ...
    <div class="grid">
        ...
        <form name="loginform" action="index.php" class="box form login" method="POST" onsubmit="return validate();">
            ...
            <input type="text" name="u_id" id="u_id" value="<?php echo $fetch_data['name'];?> ">
