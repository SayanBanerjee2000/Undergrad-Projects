...
if(!empty($_REQUEST['mode']))
{
    ...
    $sql_con="INSERT INTO `product_temp` SET 
					`cat_id`= '$cat_id', 
					`pd_name`= '$p_name', 
					`pd_quantity`= '$qty', 
					`pd_price`= '$prc',
	...
	if($res)	
	{
		@header("Location: sub_admin_product_manager.php");
		exit();
	}	
}
?>
                        ...
                        <div class="col-lg-12">
                            <div class="table-responsive">
                                <form name="sampleform" id="sampleform" method="post" action=""
                                    enctype="multipart/form-data" onSubmit="return checking();">
                                    ...
                                    <table id="second-morris-table"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><input type="number" name="cat_id" id="cat_id"></td>
                                                <td><input type="text" name="p_name" id="p_name"></td>
                                                <td><input type="number" name="qty" id="qty"></td>
                                                <td><input type="number" name="prc" id="prc"></td>
