            ...
            <ul class="nav navbar-top-links" style="display:flex;justify-content:flex-end;">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="../Live_chat_agent/chat_user.php"><i class="fas fa-headset" 
                                    ></i> Live Chat Support</a>
                        </li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <?php 
                    ...
                    {
                        $title = $_POST['search'];
                        $sql   = "SELECT * FROM `product` WHERE `p_name` LIKE '%$title%' AND cat_id = 2";
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-12">
                    ...
                    <h3>Categories</h3>
                    <a href="index.php"><button class="btn btn-success">Remove Filter</button></a>
                    <br>
                    <br>
                </div>
            </div>
            ...
            {
                echo "<script>alert('The requested item does not exist')</script>";
                echo ("<script>location.href='index_women.php'</script>");
            }
				?>
                </div>
            </div>
