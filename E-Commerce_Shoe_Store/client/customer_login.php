...
if(!empty($_REQUEST['client_mode']))
	{
					$uname=$_REQUEST['uname'];
					$pwd=$_REQUEST['pwd'];
					$sql_chk="SELECT * FROM `user_det` WHERE `loginid`='$uname' AND `password`='$pwd'";
					...
					{			
                                                ...
                                                $sql_temp = "INSERT INTO `temp` SET loginid = '$loginid', password = '$password', name = '$name' ";
                                                $res_temp = mysqli_query($con, $sql_temp);
												
												$_SESSION['client_login_status']=$loginid;
												?>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./../admin/loginstyle.css">
</head>
...
<body class="align">
    ...
    <div class="grid">
        ...
        <form name="loginform" action="" class="box form login" method="POST" onsubmit="return validate();">
            <input type="hidden" name="client_mode" id="client_mode" value="1">
            ...
            <div class="form__field">
                <input type="submit" name="client_submit_btn" value="Log In">
            </div>
