...
{
		header("Location: sub_admin_welcome.php");
		exit();
}
...
if(!empty($_REQUEST['mode']))
	{
					...
					{			
                                                ...
                                                $sql_in = "INSERT INTO `temp_admin` SET `loginid`='$loginid',
                                                            `password`='$password', 
                                                             `name`='agent'";
                                                $res_in = mysqli_query($con, $sql_in);
												$_SESSION['sub_login_status']=$loginid;
												?>
<script language='javascript'>
window.location.href = "sub_admin_welcome.php";
</script>
<?php
					}
					else
...
<body class="align">
    ...
    <div class="grid">
        ...
        <form name="loginform" action="sub_admin_login.php" class="box form login" method="POST" onsubmit="return validate();">
